...
impl AmbientDiffuseDemo {
    pub fn new(d3d_device: IDirect3DDevice9, d3d_pp: *const D3DPRESENT_PARAMETERS) -> Option<AmbientDiffuseDemo> {
        if !AmbientDiffuseDemo::check_device_caps() {
        ...
        let (fx,
            ...
            h_diffuse_mtrl,
            h_diffuse_light) =
            AmbientDiffuseDemo::build_fx(d3d_device.clone());
        ...
        let mut ambient_diffuse_demo = AmbientDiffuseDemo {
            d3d_pp,
            gfx_stats,
    ...
    fn build_fx(d3d_device: IDirect3DDevice9) -> (LPD3DXEFFECT, D3DXHANDLE, D3DXHANDLE, D3DXHANDLE,
        ...
        HR!(D3DXCreateEffectFromFile(d3d_device, PSTR(b"luna_14_ambient_diffuse_demo/ambientdiffuse.fx\0".as_ptr() as _),
        ...
        // Obtain handles.
        let h_tech = ID3DXBaseEffect_GetTechniqueByName(fx, PSTR(b"AmbientDiffuseTech\0".as_ptr() as _));
        ...
        (fx, h_tech, h_wvp, h_world_inverse_transpose, h_light_vec_w, h_ambient_mtrl, h_ambient_light, h_diffuse_mtrl, h_diffuse_light)
    }
}