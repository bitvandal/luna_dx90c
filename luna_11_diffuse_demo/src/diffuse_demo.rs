...
impl DiffuseDemo {
    pub fn new(d3d_device: IDirect3DDevice9, d3d_pp: *const D3DPRESENT_PARAMETERS) -> Option<DiffuseDemo> {
        if !DiffuseDemo::check_device_caps() {
        ...
        let (fx,
            ...
            h_diffuse_mtrl,
            h_diffuse_light) =
            DiffuseDemo::build_fx(d3d_device.clone());
        ...
        let mut diffuse_demo = DiffuseDemo {
            d3d_pp,
            gfx_stats,
    ...
    fn build_fx(d3d_device: IDirect3DDevice9) -> (LPD3DXEFFECT, D3DXHANDLE, D3DXHANDLE, D3DXHANDLE, D3DXHANDLE, D3DXHANDLE, D3DXHANDLE) {
        ...
        HR!(D3DXCreateEffectFromFile(d3d_device, PSTR(b"luna_11_diffuse_demo/diffuse.fx\0".as_ptr() as _),
