...
pub const BASE_PATH: &str = "luna_36_walk_terrain_demo/";

// Sample demo
pub struct WalkTerrainDemo {
...
impl WalkTerrainDemo {
    pub fn new(d3d_device: IDirect3DDevice9, d3d_pp: *const D3DPRESENT_PARAMETERS) -> Option<WalkTerrainDemo> {
        if !WalkTerrainDemo::check_device_caps() {
        ...
        let mut walk_terrain_demo = WalkTerrainDemo {
            d3d_pp,
            gfx_stats,
