...
impl TriGridDemo {
    pub fn new(d3d_device: IDirect3DDevice9, d3d_pp: *const D3DPRESENT_PARAMETERS) -> Option<TriGridDemo> {
        if !TriGridDemo::check_device_caps() {
...
fn build_fx(d3d_device: IDirect3DDevice9) -> (LPD3DXEFFECT, D3DXHANDLE, D3DXHANDLE) {
    ...
    HR!(D3DXCreateEffectFromFile(d3d_device, PSTR(b"luna_07_tri_grid_demo/transform.fx\0".as_ptr() as _),
